# DOCKERFILE-X:START file="./inc/long-stage-name.dockerfile" includedBy="stage-name-truncation.dockerfile" includeType="from"
...
# DOCKERFILE-X:END file="./inc/long-stage-name.dockerfile" includedBy="stage-name-truncation.dockerfile" includeType="from"
