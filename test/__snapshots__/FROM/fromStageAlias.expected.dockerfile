...
# DOCKERFILE-X:START file="./inc/downloader.dockerfile" includedBy="test/fixtures/fromStageAlias.dockerfile"
...
# DOCKERFILE-X:END file="./inc/downloader.dockerfile" includedBy="test/fixtures/fromStageAlias.dockerfile"
FROM downlofb08fb AS build-node
